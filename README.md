...
"4" - это хорошо транскрибируемая днк. часто участки после промотеров, достаточно высокий процент refseq exon и refseq gene

"5", "6", "8" - это энхансеры (H3K4me1 ассоциированна с энхансером, причем активным)[1], располагаются в начале генов, достаточно часто рядом с промотерами. 

"10" предположительно более слабый промотер, так как идет более короткими кчастками после "9", также менее выражены CpG островки и TSS. "9", соответственно, активный промотер: идет в начале гена, выражены CpG островки и TSS. Также многочисленные модификации, которые ассоциированны с данными состояниями, ассоцирированы именно с промотерами. Например, H3K4me3, отвечает за низкий уровень метилирования (собственно, промотеры низкометилированные, с cpg островками)[1]. "7" выглядит как неактивный промотер, возможно артефакт. 
...
<img width="1015" alt="Снимок экрана 2022-03-26 в 21 56 08" src="https://user-images.githubusercontent.com/60537367/160253347-95d3b429-60c7-41d4-be14-eb96dd6fac4b.png">

<img width="1030" alt="Снимок экрана 2022-03-26 в 21 57 53" src="https://user-images.githubusercontent.com/60537367/160253401-96636eb3-f789-48f7-9658-d238afe6f61e.png">
