...
"4" выглядит как слабо транскрибируемая ДНК. "5" - это гетерохроматин (наибольший процент аннотированного генома представлен гетерохроматином, также нет меток, экспресирующихся генов и ассоциированность с ядерной ламиной). "6" - выглядит как слабо транскрибируемая днк (длинные участки). 
