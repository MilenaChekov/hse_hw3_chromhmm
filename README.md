...
"1" выглядит как слабо транскрибируемая ДНК (длинные участки. "2" - это гетерохроматин (наибольший процент аннотированного генома представлен гетерохроматином, также нет меток, экспресирующихся генов и ассоциированность с ядерной ламиной). "3" - выглядит как слабо транскрибируемая днк. 
